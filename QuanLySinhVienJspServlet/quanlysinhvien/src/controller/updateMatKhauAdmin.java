...
@WebServlet( urlPatterns= { "/updatematkhauadmin" } )
public class updateMatKhauAdmin extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
    	 ...
    	 try {
    		 ...
    		 System.out.println( "updateMatKhauAdmin doGet()" );
    		 System.out.println( e );
    	 }
    	 Account acc = accDAO.checkAccount(user, pass, 1 ) ; 
